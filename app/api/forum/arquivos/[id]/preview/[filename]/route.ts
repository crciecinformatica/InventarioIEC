...
import { createArquivoPreviewResponse } from '../../../download-response'
...
export async function GET(_: Request, { params }: Props) {
  try {
    ...
    return createArquivoPreviewResponse(arquivo)
  } catch (err) {
    console.error('[GET /api/forum/arquivos/[id]/preview/[filename]]', err)
